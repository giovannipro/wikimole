...
d3.csv("../../data/edit.csv", function(error, data) { // _test
...
// set x and y domain
var sizeDomain = d3.extent(data, function(d){return +d.size }) //Math.round()
...
data.sort(function(a,b){
    var a = d3.sum(a.values, function(d){return +d.size})
    var b = d3.sum(b.values, function(d){return +d.size})
    return a - b
})
...
var area = d3.svg.area()
    ...
    .y0(function(d) { return yAxis(Math.round(+d.size)) / 10 }) // - 
    .y1(function(d) { return - yAxis(Math.round(+d.size)) / 10  });
