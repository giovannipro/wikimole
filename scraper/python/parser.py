				...
				for e in filecontents_ed:
					...
					for edge_1 in links:
						try:
							...
							if control_b < 10000:
								if node_a in links and node_a != edge_1:
									count += 1
									#print(node_a, edges, count) 

								if node_a != links and node_a != edge_1 and count != 0:
									try:
										output_b = 	\
											str(index) + t + \
											str(control_a) + t + \
									...
									print "no " + str(index) + t + str(control_a) + t + str(control_b) + t + node_a + t + edge_1
	...
	with open(myFile, "rb") as a_file:
		...
		for art in articles:
			...
			if (in_out == True):
				...
				out_box.append("0" + t + "0" + t + "0" + t + "0" + t + "0" + t + "0" + t + "0" + t + "0" + t + "0" + t + "0" + t + "0" + t + "0")
...
parse_in_links("test") # articles_details_links_2017
